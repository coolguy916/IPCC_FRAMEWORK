...
// SVG Icon for Clock Button (Fixed width and height)
const ClockIcon = () => (
  <svg
    width="24"
    height="24"
      ...
      <main className={`main-content ${sidebarOpen ? '' : 'expanded'}`}>
        <Header onToggleSidebar={toggleSidebar} sidebarOpen={sidebarOpen}>
          <h1 id="pageTitle" className="h3 text-dark mb-0">
            <strong>Economic Revenue</strong>
          </h1>
        </Header>
          ...
          <div className="row g-3 mb-4">
            <div className="col-12">
              <div className="chart-container" style={{ padding: '1.5rem', backgroundColor: '#fff', borderRadius: '12px', boxShadow: '0 2px 10px rgba(0,0,0,0.08)' }}>
                ...
                <div style={{ height: '400px', padding: '1rem', minWidth: '800px', width: '100%', overflowX: 'auto' }}>
                  <LineChart 
