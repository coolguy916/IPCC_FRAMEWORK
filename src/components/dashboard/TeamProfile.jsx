...
const TeamProfilePage = () => {
    ...
    const students = [
        { name: 'Ndyy', role: 'Team Leader', studentId: 'NIM: 2021001', imageUrl: 'https://avatar.iran.liara.run/public/girl', responsibilities: ['Lead frontend development', 'Implement UI/UX design', 'Coordinate team tasks'], email:'ndyy@example.com', linkedin:'https://linkedin.com/in/ndyy', instagram:'https://instagram.com/ndyy' },
        { name: 'Jii', role: 'Backend & Data Acquisition', studentId: 'NIM: 2021002', imageUrl: 'https://avatar.iran.liara.run/public/boy', responsibilities: ['Develop and maintain APIs', 'Optimize database', 'Implement data processing'], email:'jii@example.com', linkedin:'https://linkedin.com/in/jii', instagram:'https://instagram.com/jii' },
        { name: 'Jonathan', role: 'Frontend & Hardware', studentId: 'NIM: 2021003', imageUrl: 'https://avatar.iran.liara.run/public/boy', responsibilities: ['Configure IoT devices', 'Implement serial communication', 'Frontend integration'], email:'jonathan@example.com', linkedin:'https://linkedin.com/in/jonathan', instagram:'https://instagram.com/jonathan' },
        { name: 'Yuuuuss', role: 'Data Analyst', studentId: 'NIM: 2021004', imageUrl: 'https://avatar.iran.liara.run/public/girl', responsibilities: ['Analyze sensor data', 'Develop predictive models', 'Generate reports'], email:'yuuuss@example.com', linkedin:'https://linkedin.com/in/yuuuss', instagram:'https://instagram.com/yuuuss' },
    ];
